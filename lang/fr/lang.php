...
return [
    ...
    'heading.1' => 'Votre chauffeur privé à Paris.',
    'heading.2' => 'Déplacez-vous en toute sérénité en planifiant dès maintenant vos prochains trajets.',
    'heading.3' => 'Nous sommes à votre écoute.',
    'heading.4' => 'Que vous ayez des questions, des besoins spécifiques ou que vous souhaitiez simplement discuter, nos conseillers sont là pour vous écouter attentivement et vous accompagner à chaque étape afin de vous offrir une expérience sur mesure.',
    ...
    'faq.3.text2' => 'Veuillez contacter notre service clientèle pour obtenir des informations spécifiques sur l\'annulation ou la modification d\'une réservation après avoir effectué le paiement en ligne.',

    'faq.4.title' => 'Y a-t-il des frais supplémentaires pour les bagages volumineux ?',
    'faq.4.text1' => 'Non, nous ne facturons pas de frais supplémentaires pour les bagages volumineux. Assurez-vous simplement de mentionner le nombre et la taille des bagages lors de la réservation.',
